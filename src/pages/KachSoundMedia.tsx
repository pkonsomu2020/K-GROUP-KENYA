  ...
  <div className="min-h-screen bg-background pt-16">
    ...
    <section className="relative flex flex-col items-center justify-center text-center px-4 pt-8 pb-12 bg-brand-black overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center w-full">
        ...
        <h1 className="text-6xl md:text-7xl font-extrabold text-black mb-2">Kach Sound Media</h1>
    ...
    <section className="py-16 px-4 bg-white">
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-4">
          <img src={galleryImages[0]} alt="Kach Sound Media Event" className="rounded-xl shadow-lg object-cover w-full h-64" />
          <img src={galleryImages[1]} alt="Kach Sound Media DJ" className="rounded-xl shadow-lg object-cover w-full h-64" />
        </div>
      </div>
    </section>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          {galleryImages.map((img, idx) => (
            <img key={idx} src={img} alt="Kach Sound Media Gallery" className="rounded-xl shadow-lg object-cover w-full h-56" />
          ))}
        </div>
      </div>
    </section>
    ...
    <section className="py-16 px-4 bg-brand-red text-white text-center">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
          ...
          <a href="https://www.facebook.com/kachsoundntertainment" target="_blank" rel="noopener noreferrer" className="brand-btn-outline">Facebook Page</a>
        </div>
      </div>
    </section>
    <Footer />
