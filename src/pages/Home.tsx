...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* HERO SECTION */}
      <section className="relative min-h-[50vh] flex flex-col items-center justify-center text-center px-4 py-20 bg-background border-b border-border overflow-hidden" data-aos="fade-up">
        <video
